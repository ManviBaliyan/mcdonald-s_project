...
menu = {
    ...
    "Coke":{"price":70.00,"image":"coke.jpg"},
...
if st.session_state.page == "start": #Checks if the current page is "start"
    st.image("mdc1.jpg") #displays an image and a title 
    st.title("ORDER NOW")
...
if st.session_state.page == "menu":
    ...
    with st.sidebar:
        st.image("mac_menu_discover.jpg")
...
# Display different categories based on the selected menu
    if selected == "Home":
        ...
        display_items("Drinks & Meals", ["EVM McChicken Meal", "Cappuccino","Coke"])
